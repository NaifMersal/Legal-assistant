...
![BGE-M3 Performance](assets/evaluation_metrics_m3.png)

#### BGE-M3 with L2 Distance Indexing
![BGE-M3 L2 Performance](assets/evaluation_metrics_m3_L2.png)

### Fine-tuned Model Comparisons

#### BGE-M3-Law with Inner Product (IP) Indexing
![BGE-M3-Law Performance](assets/evaluation_metrics_law.png)

#### BGE-M3-Law with L2 Distance Indexing
![BGE-M3-Law L2 Performance](assets/evaluation_metrics_law_L2.png)

### Advanced Retrieval Strategies

#### Regular Retrieval (Dense Only)
![Regular M3 Performance](assets/evaluation_metrics_regular_m3.png)

#### Hybrid Retrieval (Dense + Sparse)
![Hybrid M3 Performance](assets/evaluation_metrics_hybrid_m3.png)

#### Reranked Results
![M3 Reranked Performance](assets/evaluation_metrics_m3_reranked.png)
