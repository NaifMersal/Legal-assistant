...
| `evaluation_report_regular_m3.json` | BGE-M3 | Regular retrieval | Enhanced pipeline |
| `evaluation_report_hybrid_m3.json` | BGE-M3 | Hybrid retrieval | Multi-strategy approach |
...
| `detailed_results_regular_m3.json` | BGE-M3 | Regular retrieval | Enhanced pipeline analysis |
| `detailed_results_hybrid_m3.json` | BGE-M3 | Hybrid retrieval | Multi-strategy detailed view |
...
| `evaluation_metrics_regular_m3.png` | BGE-M3 | Regular retrieval | Enhanced pipeline metrics |
| `evaluation_metrics_hybrid_m3.png` | BGE-M3 | Hybrid retrieval | Multi-strategy comparison |
...
| **BGE-M3** | Inner Product | Regular | Enhanced retrieval pipeline |
| **BGE-M3** | Inner Product | Hybrid | Multi-strategy combination |
...
- **Standard Retrieval**: Baseline approach
- **Regular Pipeline**: Enhanced processing
- **Hybrid Approach**: Multi-strategy combination
- **Reranking**: Post-processing optimization
